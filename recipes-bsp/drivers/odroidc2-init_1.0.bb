DESCRIPTON = "Startup script for odroidc2"
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"

FILESEXTRAPATHS_prepend := "${THISDIR}/${PN}:"

SRC_URI = "file://odroidc2-init"
...
do_install() {
    ...
    #
    install -m 0755 ${WORKDIR}/odroidc2-init  ${D}${sysconfdir}/init.d/
    ...
    #
    ln -sf ../init.d/odroidc2-init  ${D}${sysconfdir}/rcS.d/S90odroidc2-init
}
